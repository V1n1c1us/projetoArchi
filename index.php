<?php 
	$db = "biblio";
	@mysql_connect("localhost", "root,"17:08 07/04/2015") or trigger_error(mysql_error(),E_USER_ERROR);
	mysql_select_db($db);
?>
...
$busca_total = mysql_query("SELECT COUNT(*) as total FROM livros");
$total = mysql_fetch_array($busca_total);
$total = $total['total'];

	$busca = mysql_query("SELECT * FROM livros LIMIT $inicio, $limite");
